...
jQuery(document).ready(function () {
    ...
    $("#contactsubmit").bind("click", function () {
        ...
        nextButton: $("#tkr-nxt"),
        stopButton: $("#tkr-stop")
    }), $(".mag-info a").tooltip(), $("select.cust-slctr").customSelect()
...
$(window).scroll(function () {
    ...
    $(this).scrollTop() > 160 && !0 !== hidemenu && "hide" !== e ? (nav.addClass("f-nav"), $("#hidemenu").show()) : (nav.removeClass("f-nav"), $("#hidemenu").hide())
});