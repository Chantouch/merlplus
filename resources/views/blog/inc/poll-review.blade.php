...
<div class="polls-cont">
    <div class="polls-left blocky">
        <a href="#"><img alt="Image blog default page" class="polls-bg-img" src="blog/img/samples/z4.jpg"/></a>
        <div class="pol-lft-txt">
            <h4 class="float-width">Pizza will be delivered by Drons</h4>
            <a href="#" class="lefty"><img alt="Image blog default page" src="blog/img/4-stars.png"/></a>
    ...
    <div class="polls-right lefty">
        <div class="pol-rt-sm float-width">
            <a href="#" class="lefty pol-rt-img"><img alt="Image blog default page" src="blog/img/samples/m1.jpg"/></a>
        ...
        <div class="pol-rt-sm float-width">
            <a href="#" class="lefty pol-rt-img"><img alt="Image blog default page" src="blog/img/samples/m2.jpg"/></a>
        ...
        <div class="pol-rt-sm float-width">
            <a href="#" class="lefty pol-rt-img"><img alt="Image blog default page" src="blog/img/samples/m3.jpg"/></a>
        ...
        <div class="pol-rt-sm float-width">
            <a href="#" class="lefty pol-rt-img"><img alt="Image blog default page" src="blog/img/samples/m4.jpg"/></a>
