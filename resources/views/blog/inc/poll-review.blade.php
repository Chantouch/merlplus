...
<div class="polls-cont">
    <div class="polls-left blocky">
        <a href="#"><img alt="" class="polls-bg-img" data-echo="blog/img/samples/z4.jpg"/></a>
        <div class="pol-lft-txt">
            <h4 class="float-width">Pizza will be delivered by Drons</h4>
            <a href="#" class="lefty"><img alt="" data-echo="blog/img/4-stars.png"/></a>
    ...
    <div class="polls-right lefty">
        <div class="pol-rt-sm float-width">
            <a href="#" class="lefty pol-rt-img"><img alt="" data-echo="blog/img/samples/m1.jpg"/></a>
            <h5>Pizza will be delivered by Drons</h5>
            <h6 class="lefty"><span><i class="fa fa-clock-o"></i>20 Jan 2014</span><span><i
                            class="fa fa-comment-o"></i>21 comments</span></h6>
            <a href="#" class="lefty stars"><img alt="" data-echo="blog/img/4-stars.png"/></a>
        </div>
        <div class="pol-rt-sm float-width">
            <a href="#" class="lefty pol-rt-img"><img alt="" data-echo="blog/img/samples/m2.jpg"/></a>
        ...
        <div class="pol-rt-sm float-width">
            <a href="#" class="lefty pol-rt-img"><img alt="" data-echo="blog/img/samples/m3.jpg"/></a>
        ...
        <div class="pol-rt-sm float-width">
            <a href="#" class="lefty pol-rt-img"><img alt="" data-echo="blog/img/samples/m4.jpg"/></a>
