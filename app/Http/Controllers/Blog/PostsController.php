...
class PostsController extends BaseController
{
	...
	public function show($idOrSlug)
	{
		...
		$single_article_ads = $ads->where('advertise_type_id', 9)->get();
		$button_single_ads = $ads->where('advertise_type_id', 12)->get();
		...
		return view($this->view . 'show', compact(
			'post', 'comments', 'previousPost', 'nextPost', 'single_article_ads', 'button_single_ads'
		));
	}
}
